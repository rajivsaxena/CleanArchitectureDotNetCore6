...
namespace Drona.AyushmanBharat.Infrastructure.Migrations
{
    ...
    [Migration("20230812100533_AddDoctorUniversityAndCollege")]
    partial class AddDoctorUniversityAndCollege
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Drona.AyushmanBharat.Domain.Entities.ABDM.HPR.HPRMaster.DoctorCollege", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("HprCollegeId")
                        .HasColumnType("int");

                    b.Property<int>("HprUniversityId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HprUniversityId");

                    b.ToTable("DoctorColleges");
                });
            ...
            modelBuilder.Entity("Drona.AyushmanBharat.Domain.Entities.ABDM.HPR.HPRMaster.DoctorUniversity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Drona.AyushmanBharat.Domain.Entities.ABDM.HPR.HPRMaster.DoctorCollege", b =>
                {
                    b.HasOne("Drona.AyushmanBharat.Domain.Entities.ABDM.HPR.HPRMaster.DoctorUniversity", "HprUniversity")
                        .WithMany("DoctorColleges")
                        .HasForeignKey("HprUniversityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("HprUniversity");
                });
